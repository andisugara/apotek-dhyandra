...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('pengeluaran.update', $pengeluaran->id) }}" method="POST" id="formEditPengeluaran">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        <input type="text" name="nama" id="nama"
                            ...
                            value="{{ old('nama', $pengeluaran->nama) }}" placeholder="Masukkan nama pengeluaran"
                            required />
                        @error('nama')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#jumlah').on('input', function() {
                ...
                $("#formEditPengeluaran").validate().element("#jumlah");
            });
        });
    </script>
@endpush
