            ...
            <form action="{{ route('obat.update', $obat->id) }}" method="POST" id="obatForm">
                ...
                <div class="tab-content">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <input type="text" class="form-control @error('kode_obat') is-invalid @enderror"
                                        name="kode_obat" value="{{ old('kode_obat', $obat->kode_obat) }}" />
                                    <span class="form-text text-muted">Kode akan otomatis diawali dengan 'OBT'</span>
                                    @error('kode_obat')
                                    ...
                                    <select name="pabrik_id" class="form-select @error('pabrik_id') is-invalid @enderror"
                                        ...
                                        @foreach ($pabriks as $pabrik)
                                            <option value="{{ $pabrik->id }}"
                                                {{ old('pabrik_id', $obat->pabrik_id) == $pabrik->id ? 'selected' : '' }}>
                                                {{ $pabrik->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="golongan_id"
                                        ...
                                        @foreach ($golongans as $golongan)
                                            <option value="{{ $golongan->id }}"
                                                {{ old('golongan_id', $obat->golongan_id) == $golongan->id ? 'selected' : '' }}>
                                                {{ $golongan->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <input type="text" class="form-control @error('jenis_obat') is-invalid @enderror"
                                        name="jenis_obat" value="{{ old('jenis_obat', $obat->jenis_obat) }}" required />
                                    @error('jenis_obat')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <input type="number" class="form-control @error('minimal_stok') is-invalid @enderror"
                                        name="minimal_stok" value="{{ old('minimal_stok', $obat->minimal_stok) }}" required
                                        min="0" />
                                    @error('minimal_stok')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <select name="is_active" class="form-select @error('is_active') is-invalid @enderror"
                                        required>
                                        <option value="1"
                                            {{ old('is_active', $obat->is_active) == '1' ? 'selected' : '' }}>Aktif
                                        </option>
                                        <option value="0"
                                            {{ old('is_active', $obat->is_active) == '0' ? 'selected' : '' }}>Non Aktif
                                        </option>
                                    </select>
                                    @error('is_active')
                                        <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <input type="text" class="form-control @error('kemasan') is-invalid @enderror"
                                        name="kemasan" value="{{ old('kemasan', $obat->kemasan) }}" />
                                    @error('kemasan')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <textarea name="indikasi" class="form-control @error('indikasi') is-invalid @enderror" rows="3">{{ old('indikasi', $obat->indikasi) }}</textarea>
                                    @error('indikasi')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <textarea name="kandungan" class="form-control @error('kandungan') is-invalid @enderror" rows="3">{{ old('kandungan', $obat->kandungan) }}</textarea>
                                    @error('kandungan')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <textarea name="dosis" class="form-control @error('dosis') is-invalid @enderror" rows="3">{{ old('dosis', $obat->dosis) }}</textarea>
                                    @error('dosis')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <textarea name="efek_samping" class="form-control @error('efek_samping') is-invalid @enderror" rows="3">{{ old('efek_samping', $obat->efek_samping) }}</textarea>
                                    @error('efek_samping')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <textarea name="zat_aktif_prekursor" class="form-control @error('zat_aktif_prekursor') is-invalid @enderror"
                                        rows="3">{{ old('zat_aktif_prekursor', $obat->zat_aktif_prekursor) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-5">
                                    ...
                                    <textarea name="aturan_pakai" class="form-control @error('aturan_pakai') is-invalid @enderror" rows="3">{{ old('aturan_pakai', $obat->aturan_pakai) }}</textarea>
                                    @error('aturan_pakai')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                    ...
                    <div class="tab-pane fade" id="tab_satuan" role="tabpanel">
                        ...
                        <div class="table-responsive">
                            <table class="table table-row-dashed table-row-gray-300 align-middle" id="satuanTable">
                                ...
                                <tbody>
                                    @foreach ($obat->satuans as $satuanObat)
                                        <tr id="satuan-row-{{ $satuanObat->satuan_id }}">
                                            <td>{{ $satuanObat->satuan->nama }}</td>
                                            <td>{{ number_format($satuanObat->harga_beli, 0, ',', '.') }}</td>
                                            <td>{{ $satuanObat->diskon_persen }}%</td>
                                            <td>{{ $satuanObat->profit_persen ?? 10 }}%</td>
                                            <td>{{ number_format($satuanObat->harga_jual, 0, ',', '.') }}</td>
                                            <td>
                                                <button type="button" class="btn btn-sm btn-primary btn-edit-satuan"
                                                    data-satuan-id="{{ $satuanObat->satuan_id }}"
                                                    data-satuan-text="{{ $satuanObat->satuan->nama }}"
                                                    data-harga-beli="{{ $satuanObat->harga_beli }}"
                                                    data-diskon-persen="{{ $satuanObat->diskon_persen }}"
                                                    data-profit-persen="{{ $satuanObat->profit_persen ?? 10 }}"
                                                    data-harga-jual="{{ $satuanObat->harga_jual }}">
                                                    Edit
                                                </button>
                                                <button type="button" class="btn btn-sm btn-danger btn-delete-satuan"
                                                    data-satuan-id="{{ $satuanObat->satuan_id }}">
                                                    Hapus
                                                </button>
                                            </td>
                    ...
                    <div class="tab-pane fade" id="tab_stok" role="tabpanel">
                        ...
                        <div class="d-flex justify-content-end mb-5">
                            <button type="button" class="btn btn-sm btn-primary" id="btnAddStok"
                                {{ $obat->satuans->count() > 0 ? '' : 'disabled' }}>
                        ...
                        <div class="table-responsive">
                            <table class="table table-row-dashed table-row-gray-300 align-middle" id="stokTable">
                                ...
                                <tbody>
                                    @foreach ($obat->stok as $stokItem)
                                        <tr id="stock-row-{{ $stokItem->id }}">
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-danger btn-delete-stock"
                                                    ...
                                                    {{ $stokItem->pembelian_detail_id ? 'disabled' : '' }}>
                                                    Hapus
                                                </button>
                                            </td>
                                        </tr>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalSatuanTitle">Tambah Satuan Obat</h5>
                    ...
                    <form id="formAddStok">
                        <div class="mb-5">
                            ...
                            <select name="satuan_id" class="form-select" required>
                                <option value="">-- Pilih Satuan --</option>
                                @foreach ($obat->satuans as $satuanObat)
                                    <option value="{{ $satuanObat->satuan_id }}">{{ $satuanObat->satuan->nama }}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback"></div>
                        </div>
...
@push('scripts')
    <!-- Store data in JSON format to avoid Blade/JavaScript syntax issues -->
    <script type="application/json" id="satuanData">
        {!! json_encode($obat->satuans->map(function ($satuanObat) {
            return [
                'id' => $satuanObat->id,
                'satuan_id' => $satuanObat->satuan_id,
                'satuan_text' => $satuanObat->satuan->nama,
                'harga_beli' => $satuanObat->harga_beli,
                'diskon_persen' => $satuanObat->diskon_persen,
                'profit_persen' => $satuanObat->profit_persen ?? 10,
                'harga_jual' => $satuanObat->harga_jual,
            ];
        })) !!}
    </script>

    <script type="application/json" id="stokData">
        {!! json_encode($obat->stok->map(function ($stokItem) {
            return [
                'id' => $stokItem->id,
                'satuan_id' => $stokItem->satuan_id,
                'lokasi_id' => $stokItem->lokasi_id,
    ...
    <script>
        // Parse JSON data from the separate script tags
        let satuans = JSON.parse(document.getElementById('satuanData').textContent);
        let stocks = JSON.parse(document.getElementById('stokData').textContent);

        // Array to track stocks to be deleted
        let stocksToDelete = [];

        // Array to track satuans to be deleted
        let satuansToDelete = [];
        ...
        $(document).ready(function() {
            ...
            $('#btnAddSatuan').on('click', function() {
                // Reset form
                $('#formSatuan')[0].reset();
                $('#formSatuan input[name="edit_mode"]').val('0');
                $('#formSatuan select[name="satuan_id"]').val('').prop('disabled', false);
                $('#formSatuan .is-invalid').removeClass('is-invalid');
                $('#modalSatuanTitle').text('Tambah Satuan Obat');
            ...
            $(document).on('click', '.btn-edit-satuan', function() {
                ...
                const satuanText = $(this).data('satuan-text');
                const hargaBeli = $(this).data('harga-beli');
                const diskonPersen = $(this).data('diskon-persen');
                const hargaJual = $(this).data('harga-jual');
                const profitPersen = $(this).data('profit-persen') || 10; // Default to 10% if not set
                ...
                // Set values
                $('#formSatuan input[name="edit_mode"]').val('1');
                $('#formSatuan select[name="satuan_id"]').val(satuanId).prop('disabled', true);
                $('#formSatuan input[name="harga_beli"]').val(hargaBeli.toLocaleString('id-ID'));
                $('#formSatuan input[name="diskon_persen"]').val(diskonPersen);
                $('#formSatuan input[name="profit_persen"]').val(profitPersen);
                $('#formSatuan input[name="harga_jual"]').val(hargaJual.toLocaleString('id-ID'));

                $('#modalSatuanTitle').text('Edit Satuan Obat');
                $('#modalSatuan').modal('show');
            });
            ...
            $('#btnSaveSatuan').on('click', function() {
                // Get form data
                const editMode = $('#formSatuan input[name="edit_mode"]').val() === '1';
                const satuanId = $('#formSatuan select[name="satuan_id"]').val();
                const hargaBeli = $('#formSatuan input[name="harga_beli"]').val().replace(/\D/g, '');
                const diskonPersen = $('#formSatuan input[name="diskon_persen"]').val();
                const profitPersen = $('#formSatuan input[name="profit_persen"]').val();
                const hargaJual = $('#formSatuan input[name="harga_jual"]').val().replace(/\D/g, '');

                // Validate form
                let isValid = true;

                if (!satuanId) {
                    $('#formSatuan select[name="satuan_id"]').addClass('is-invalid');
                    $('#formSatuan select[name="satuan_id"]').next('.invalid-feedback').text(
                        'Pilih satuan');
                    isValid = false;
                } else {
                    $('#formSatuan select[name="satuan_id"]').removeClass('is-invalid');
                }

                if (!hargaBeli) {
                    $('#formSatuan input[name="harga_beli"]').addClass('is-invalid');
                    $('#formSatuan input[name="harga_beli"]').next('.invalid-feedback').text(
                        'Harga beli harus diisi');
                    isValid = false;
                } else {
                    $('#formSatuan input[name="harga_beli"]').removeClass('is-invalid');
                }

                if (!hargaJual) {
                    $('#formSatuan input[name="harga_jual"]').addClass('is-invalid');
                    $('#formSatuan input[name="harga_jual"]').next('.invalid-feedback').text(
                        'Harga jual harus diisi');
                    isValid = false;
                } else {
                    $('#formSatuan input[name="harga_jual"]').removeClass('is-invalid');
                }
                ...
                // Check if satuan already exists (only in add mode)
                if (!editMode && satuans.some(item => item.satuan_id == satuanId)) {
                    $('#formSatuan select[name="satuan_id"]').addClass('is-invalid');
                    $('#formSatuan select[name="satuan_id"]').next('.invalid-feedback').text(
                ...
                // Get satuan name
                const satuanText = $('#formSatuan select[name="satuan_id"] option:selected').text();

                if (editMode) {
                    // Update existing satuan
                    const satuanIndex = satuans.findIndex(item => item.satuan_id == satuanId);
                    if (satuanIndex !== -1) {
                        satuans[satuanIndex].harga_beli = hargaBeli;
                        satuans[satuanIndex].diskon_persen = diskonPersen || 0;
                        satuans[satuanIndex].profit_persen = profitPersen || 10;
                        satuans[satuanIndex].harga_jual = hargaJual;

                        // Update row in table
                        $(`#satuan-row-${satuanId}`).html(`
                            <td>${satuanText}</td>
                            ...
                            <td>
                                <button type="button" class="btn btn-sm btn-primary btn-edit-satuan"
                                    ...
                                    data-satuan-text="${satuanText}"
                                    data-harga-beli="${hargaBeli}"
                                    data-diskon-persen="${diskonPersen || 0}"
                                    data-profit-persen="${profitPersen || 10}"
            ...
            $(document).on('click', '.btn-delete-satuan', function() {
                ...
                // Find the satuan record ID in the satuans array
                const satuanToDelete = satuans.find(item => item.satuan_id == satuanId);
                if (satuanToDelete && satuanToDelete.id) {
                    satuansToDelete.push(satuanToDelete.id);
                }
            ...
            // Update stock qty
            $(document).on('change', '.stock-qty', function() {
                const stockId = $(this).data('stock-id');
                const qty = parseInt($(this).val());

                // Update qty in stocks array
            ...
            $(document).on('click', '.btn-delete-stock', function() {
                ...
                // Check if this is an existing stock
                if (String(stockId).indexOf('new-') === -1) {
                    stocksToDelete.push(stockId);
                }
        ...
        function updateHiddenInputs() {
            ...
            $('input[name^="delete_stok["]').remove();
            $('input[name^="delete_satuan["]').remove();

            // Add hidden inputs for satuans
            satuans.forEach((satuan, index) => {
                const prefix = `satuan[${index}]`;
                $('#obatForm').append(`<input type="hidden" name="${prefix}[id]" value="${satuan.id || ''}">`);
                $('#obatForm').append(
            ...
            // Add hidden inputs for satuans to delete
            satuansToDelete.forEach((satuanId, index) => {
                $('#obatForm').append(`<input type="hidden" name="delete_satuan[${index}]" value="${satuanId}">`);
            });

            // Add hidden inputs for stocks
            stocks.forEach((stok, index) => {
                const prefix = `stok[${index}]`;
                $('#obatForm').append(`<input type="hidden" name="${prefix}[id]" value="${stok.id}">`);
                $('#obatForm').append(
            ...
            stocksToDelete.forEach((stockId, index) => {
                $('#obatForm').append(`<input type="hidden" name="delete_stok[${index}]" value="${stockId}">`);
            });
        }
        ...
        function calculateSellingPrice() {
            const hargaBeliInput = $('#formSatuan input[name="harga_beli"]');
            const profitPersenInput = $('#formSatuan input[name="profit_persen"]');
            const hargaJualInput = $('#formSatuan input[name="harga_jual"]');
