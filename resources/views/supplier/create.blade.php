                    ...
                    <div class="col-md-6">
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control @error('kode') is-invalid @enderror" name="kode"
                                value="{{ old('kode', 'SUP' . date('ymd') . '0001') }}" placeholder="SUPYYMMDDxxxx" />
                    ...
                    <div class="col-md-6">
                        <div class="mb-5">
                            ...
                            <input type="text" class="form-control @error('telepone') is-invalid @enderror"
                                name="telepone" value="{{ old('telepone') }}" required />
                            @error('telepone')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-5">
                            ...
                            <input type="number" class="form-control @error('lead_time') is-invalid @enderror"
                                name="lead_time" value="{{ old('lead_time', 0) }}" required min="0" />
                            @error('lead_time')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
