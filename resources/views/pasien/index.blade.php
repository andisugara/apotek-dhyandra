...
@section('content')
    ...
    <div class="card">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <a href="{{ route('pasien.create') }}" class="btn btn-primary">
                        <i class="ki-duotone ki-plus fs-2"></i>Tambah Pasien
                    </a>
                    <!--end::Add user-->
                </div>
                <!--end::Toolbar-->
        ...
        <div class="card-body py-4">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="pasienTable">
                <thead>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#pasienTable').on('click', '.btn-delete', function() {
                ...
                $('#deleteForm').attr('action', `{{ url('pasien') }}/${id}`);
